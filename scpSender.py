...
class ScpUploadApp:
    def __init__(self, master):
        ...
        self.server_address = "192.168.1.182"
        self.username = "chacaltordu"
        ...
        tk.Entry(master, textvariable=self.password, show='*').grid(row=12, column=0, padx=10, pady=5, sticky=tk.W)
